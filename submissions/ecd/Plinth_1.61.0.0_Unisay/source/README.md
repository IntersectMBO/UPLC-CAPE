...
This submission compiles `lib/Ecd.hs` from the Plinth source repository with the Plinth (plutus-tx-plugin) 1.61.0.0 line.
...
The produced UPLC writes to `$CAPE_REPO/submissions/ecd/Plinth_1.61.0.0_Unisay/ecd.uplc` and matches the `ecd.uplc` in this submission.
