...
This submission compiles `lib/Ecd.hs` from the Plinth source
...
`$CAPE_REPO/submissions/ecd/Plinth_1.64.0.0_Unisay/ecd.uplc`
and matches the `ecd.uplc` in this submission.
