...
The produced UPLC writes to `$CAPE_REPO/submissions/factorial_naive_recursion/Plinth_1.61.0.0_Unisay/factorial.uplc`, because the generator at this commit names the artifact after the Haskell module. CAPE renamed it to `factorial_naive_recursion.uplc` (PR #203), which is the file in this directory, and the contents match.
