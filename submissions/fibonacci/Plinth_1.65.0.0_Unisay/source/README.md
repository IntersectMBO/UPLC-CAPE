...
The produced UPLC writes to `$CAPE_REPO/submissions/fibonacci/Plinth_1.65.0.0_Unisay_preview/fibonacci.uplc`, because the generator at this commit still names the casing output `_preview`. That file is this submission's artifact, moved into this directory when the preview track was retired, and it matches the UPLC here.
