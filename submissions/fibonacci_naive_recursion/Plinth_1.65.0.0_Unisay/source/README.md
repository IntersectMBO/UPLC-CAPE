...
The produced UPLC writes to `$CAPE_REPO/submissions/fibonacci_naive_recursion/Plinth_1.65.0.0_Unisay/fibonacci_naive_recursion.uplc` and matches the UPLC in this submission.
