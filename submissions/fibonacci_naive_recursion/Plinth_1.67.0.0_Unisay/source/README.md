# fibonacci_naive_recursion Plinth 1.67.0.0 source
...
The produced UPLC writes to `$CAPE_REPO/submissions/fibonacci_naive_recursion/Plinth_1.67.0.0_Unisay/fibonacci_naive_recursion.uplc` and matches the UPLC in this submission. This is the first Plinth line whose generator writes straight to the directory CAPE publishes, because there is no longer a casing variant to name apart.
