# two_party_escrow Plinth 1.67.0.0 asData source
...
The produced UPLC writes to `$CAPE_REPO/submissions/two_party_escrow/Plinth_1.67.0.0_Unisay_asdata/two_party_escrow.uplc` and matches the UPLC in this submission. This is the first Plinth line whose generator writes straight to the directory CAPE publishes, because there is no longer a casing variant to name apart.
